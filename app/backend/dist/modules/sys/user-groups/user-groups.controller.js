...
__decorate([
    (0, common_1.Post)(),
    openapi.ApiResponse({ status: 201, type: require("./entities/user-group.entity").UserGroup }),
...
__decorate([
    (0, common_1.Get)(),
    openapi.ApiResponse({ status: 200, type: [require("./entities/user-group.entity").UserGroup] }),
    __metadata("design:type", Function),
